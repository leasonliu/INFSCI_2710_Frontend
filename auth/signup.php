    ...
    <div class="container" ng-app="myApp" ng-controller="myCtrl">
        ...
        <div class="card card-container">
            ...
            <form class="form-signinup" id="signup" novalidate>
                ...
                <div class="form-row">
                    <div class="col"><input type="password" class="form-control" id="input_pw1" required placeholder="Password"></div>
                    <div class="col"><input type="password" class="form-control" id="input_pw2" required placeholder="Repeat it"></div>
                </div>
                <div class="form-row">
